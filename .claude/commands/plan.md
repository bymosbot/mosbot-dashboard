...
4. **Include Testing Framework in Repository Context**:
   - Reference testing frameworks and directories from Cursor rules or Copilot instructions
...
- Include technology stack and testing framework information from Cursor rules or Copilot instructions.
...
- **Testing tasks align with Cursor rules or Copilot instructions**: Reference `.cursor/rules/testing-standards.mdc` or `.github/instructions/testing-standards.instructions.md` or equivalent for testing strategy.
